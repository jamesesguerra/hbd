        ...
        <div className="flex items-start gap-2.5">
            ...
            >
                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    <span className="text-sm font-normal text-gray-500">{timeString}</span>
                </div>
                <p className="text-sm font-normal py-2.5 text-white">hi baby, can i take u out on ur bday? jus click d 3 dots on d ryt w ur ans😀</p>
            ...
            {!showReply && (
                <>
                    <button id="dropdownMenuIconButton" data-dropdown-toggle="dropdownDots" data-dropdown-placement="bottom-start" className="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-teal-950 dark:hover:bg-teal-900 dark:focus:ring-gray-600" type="button">
                        <svg className="w-4 h-4 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 4 15">
                            <path d="M3.5 1.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 6.041a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 5.959a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/>
                        </svg>
                    </button>
                    <div id="dropdownDots" className="z-10 hidden divide-y rounded-lg shadow w-40 bg-teal-950 divide-gray-600">
                        <ul className="py-2 text-sm text-gray-200" aria-labelledby="dropdownMenuIconButton">
                            <li>
                                <a
                                    data-modal-target="crud-modal"
                                    data-modal-toggle="crud-modal"
                                    className="block px-4 py-2 hover:cursor-pointer hover:text-white">Yes</a>
                            </li>
                            <li>
                                <a
                                    data-modal-target="crud-modal"
                                    ...
                                    className="block px-4 py-2 hover:cursor-pointer hover:text-white">No</a>
                            </li>
                        </ul>
                    </div>
                </>
        ...
        {showReply && (
            <div className="flex items-start gap-2.5 mt-1 ml-14">
                <div className="flex flex-col w-full max-w-[400px] leading-1.5 p-4 border-gray-200 rounded-e-xl rounded-es-xl bg-teal-950">
                    <div className="flex items-center space-x-2 rtl:space-x-reverse">
                        <span className="text-sm font-semibold text-white">bear</span>
                        <span className="text-sm font-normal text-gray-400">{timeString}</span>
                    </div>
                    <p className="text-sm font-normal py-2.5 text-white">yay, see u baby, i love u</p>
