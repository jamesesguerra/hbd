                ...
                <form className="p-4 md:p-5" onSubmit={handleSubmit}>
                    <div className="grid gap-4 mb-4 grid-cols-2">
                        <div className="col-span-2">
                            <label htmlFor="mall" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">mall</label>
                            <select
                                value={mall}
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <label htmlFor="default-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">let me decide</label>
                        </div>
                    </div>
